...
- `algorithms` module
- `bfs()`, `shortest_path()`, `all_shortest_paths()`, `connected_components()`, `neighborhood()` algorithms with engine wrapper
...
[unreleased]: https://github.com/mkh-user/graphite/compare/v0.5...HEAD
[0.5]: https://github.com/mkh-user/graphite/releases/tag/v0.5
